...
config :inmana, Inmana.Mailer, adpter: Bamboo.LocalAdapter

# Configures the endpoint
config :inmana, InmanaWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "5wvrVGmpHtEDAJEG8ofzjFVPA/SWesczjm3aRkdRqh3JDQdkPM+rryGECE7kVPS7",
  render_errors: [view: InmanaWeb.ErrorView, accepts: ~w(json), layout: false],
  pubsub_server: Inmana.PubSub,
  live_view: [signing_salt: "gu9Fxq6n"]
